...
async function getResource(id, setName, setActive, setEnvironment, setResourceType, setipv4, setipv6, setUsername, setPort, setProtocol) {
...
function UpdateResource({ id, show, setShow, refetch = null }) {
    ...
    const { data: resourceData, isFetching } = useQuery(
        ['resource-' + id],
        () => getResource(id, setName, setActive, setEnvironment, setResourceType, setipv4, setipv6, setUsername, setPort, setProtocol),
