...
async function fetchUsers(page = 1, requestParams = []) {
  ...
  const { data } = await Axios.get('/v1/users?page=' + page + '&' + queryString)
  return data;
}
...
export default function Users() {
  ...
  const handleSendPasswordReset = (e, id) => {
    ...
    toast.promise(sendPasswordRecoveryEmail(id), {
      pending: 'Processing',
      success: { render({ data }) { return `Password recovery email sent` } },
    ...
    <div>
      ...
      <div className="row">
        <div className="col-md-6">
          <h6>Filter by</h6>
          <InputV1 label="User Name" value={usernameFilter} setValue={setUsernameFilter} />
          {roleOptions ?
              ...
              return (
                <tr key={dataIndex}>
                  ...
                  <td width="250px" align="center">
                    <a href="#" className="btn btn-outline-primary btn-sm" onClick={(e) => { handleSendPasswordReset(e, d.id) }}>Password Reset</a>&nbsp;
